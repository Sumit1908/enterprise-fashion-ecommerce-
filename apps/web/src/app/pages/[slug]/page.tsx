...
const PAGES: Record<string, InfoPage> = {
  ...
  'shipping-policy': {
    ...
    blocks: [
      ...
      { h: 'Charges' },
      { list: [
        `Free standard shipping on orders over ₹${SITE.freeShippingThreshold}.`,
        `Below ₹${SITE.freeShippingThreshold}, a flat ₹${SITE.standardShippingFee} standard shipping fee applies.`,
        `Express delivery is available for ₹${SITE.expressShippingFee} where serviceable.`,
        `Cash on Delivery is available across India with a ₹${SITE.codFee} handling fee.`,
      ] },
      ...
      { list: [
        ...
        'Express delivery: 1–3 business days after dispatch.',
